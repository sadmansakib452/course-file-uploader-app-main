...
export const fields = [
  ...
  },
  {
    ...
    label: "2. Was the time available in the semester sufficient to cover the course contents?",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "teaching_methods",
    label: "3. Please mention the teaching learning methods used throughout the course.",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "class_participation",
    label: "4. Please comment on the tendency of individual class participations of students during classes.",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "e_platform_usage",
    label: "5. Was there use of any e-platform for communication in course purposes?",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "classroom_size_effect",
    label: "6. Has the number of students with respect to classroom size affected teaching-learning interactions in the course?",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "assessment_performance",
    label: "7. Please comment on the trend of students' performances in different assessment approaches used throughout the course.",
    placeholder: "Your comments",
    section: "Course Content",
  },
  {
    name: "observation_suggestion",
    label: "8. Please mention overall observations and suggestions for the course",
    placeholder: "Your comments",
    section: "Course Content",
  },
];
